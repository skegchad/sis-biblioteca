  ...
  <head>
    ...
    <style>
        .banner-biblioteca {
            ...
            background-image: linear-gradient(rgba(240, 240, 240, 0.3), rgba(0, 0, 0, 0.3)), url(img/IMAGENES\ DEL\ CATALOGO/libross.jpeg);
              ...
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="<?php echo $URL;?>/public/assets/img/user1-128x128.jpg"
                        alt="User Avatar"
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="<?php echo $URL;?>/public/assets/img/user8-128x128.jpg"
                        alt="User Avatar"
                        class="img-size-50 rounded-circle me-3"
                      />
                    </div>
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="<?php echo $URL;?>/public/assets/img/user3-128x128.jpg"
                        alt="User Avatar"
                        class="img-size-50 rounded-circle me-3"
                      />
                    </div>
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="<?php echo $URL;?>/admin" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">SISTEMA BIBLIOTECA</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
