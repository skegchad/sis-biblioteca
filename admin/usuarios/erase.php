                            ...
                            <form action="controller_erase.php?id=<?php echo $id_get;?>" method="post">    
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" value="<?php echo $nombre;?>" name="Nombres" id="Nombre" class="form-control" disabled>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="Apellidos" class="form-label">Apellidos</label>
                                        <input type="text" value="<?php echo $apellidos;?>" name="Apellidos" id="Apellidos" class="form-control" disabled>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="Cedula" class="form-label">Cédula</label>
                                        <input type="number" value="<?php echo $cedula;?>" name="Cedula" id="Cedula" class="form-control" disabled>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select name="Cargo" class="form-select" id="Cargo" onchange="mostrarCurso(this)" disabled>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" value="<?php echo $nombreusuario;?>" name="Nombreusuario" id="Nombreusuario" class="form-control" disabled>
                                    </div>
                                </div>
                                <div class="row" id="seccion-curso" style="display:none;">
                                    <div class="col-md-6">
                                        ...
                                        <select name="Curso" id="Curso" class="form-select" onchange="filtrarParalelo(this)" disabled>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="Paralelo" id="Paralelo" class="form-select" disabled>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 d-grid gap-2">
                                        <div class="d-grid gap-2">
                                            <button class="btn btn-danger" onclick="return confirm('¿Estás seguro de eliminar a este usuario?')" type="submit">Eliminar Usuario</button>
                                        </div>
                                    </div>
                                    <div class="col-md-2"></div>
                                </div>
