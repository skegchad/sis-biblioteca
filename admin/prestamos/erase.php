        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="controller_erase.php?id=<?php echo $id_prestamo;?>" method="post" id="formDevolverPrestamo">
                        <fieldset disabled>
                            <input
                                type="hidden"
                                name="id_prestamo"
...
<script>
    ...
    Swal.fire({
        ...
        text:"Se devolvera este libro y habra uno más de este disponible.",
